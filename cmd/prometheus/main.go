...
func main() {
	...
	a.Flag("gomemlimit.ratio", "The ratio of detected memomry limit (container/system) used to set the GOMEMLIMIT").
	...
	if cfg.memlimitRatio <= 0.0 || cfg.memlimitRatio > 1.0 {
		fmt.Fprintf(os.Stderr, "--gomemlimit.ratio must be greater than 0 and less than or equal to 1.")
		os.Exit(1)
	}
